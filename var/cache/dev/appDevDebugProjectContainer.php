...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b' => 'get16dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64bService',
            '2_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b' => 'get26dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64bService',
        ...
        $this->privates = array(
            '1_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b' => true,
            '2_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b']) ? $this->services['1_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b'] : $this->get16dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64bService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b']) ? $this->services['2_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b'] : $this->get26dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64bService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sebcom', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\sebcomBundle\\Resources\\config\\doctrine') => 'sebcomBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'sebcomBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('sebcomBundle' => 'sebcomBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_1b7b151d67efe4d2c4cfa24845383b9b5636bcfb77c9c1be392be13fe34cb535');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\sebcomBundle/Resources/views'), 'sebcom');
    ...
    /**
     * Gets the private '1_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get16dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64bService()
    {
        return $this->services['1_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get26dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64bService()
    {
        return $this->services['2_6dfe672e4c566fea380bf539ff6bf5be56537b0103c07bc210751ae1a595b64b'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('VHBC2VPExr', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E9T-5aRzLR', 0, '8TSyaMd+V5HkGlFy4Ecfln', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LKO-dmltKt', 0, '8TSyaMd+V5HkGlFy4Ecfln', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aWOSXSIazk', 0, '8TSyaMd+V5HkGlFy4Ecfln', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59f37cb9702ec7.62870699');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'sebcomBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\sebcomBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'sebcomBundle' => 'sebcomBundle\\sebcomBundle',
